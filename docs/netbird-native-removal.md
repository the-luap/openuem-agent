...
The native observer must prove exact receipt/version, protected bundle contents,
CLI link and service ownership, then construct the complete state fingerprint.
